...
class Learn2Learn_Database {
    ...
    public function select_user_thumbs_for_lesson($username, $lesson_id, $user_id = null){
        ...
        $user_thumbs_records = $this->select_from_table($this->thumbs_table, array("user_id" => "%s", "page_id" => "%d"), array($username, $lesson_id), array("thumbs"));

        return (is_array($user_thumbs_records) ? reset($user_thumbs_records) : $user_thumbs_records);
